"""First-pass task decomposition for M1.

This is intentionally deterministic so the orchestration boundary is clear
before an LLM planner is introduced.
"""
...
def plan(project_request: str) -> list[Task]:
    """Convert a simple project request into a small executable task list."""
